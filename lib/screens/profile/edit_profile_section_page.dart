        ...
        body: ListView(
          ...
          children: [
            ...
            _buildSectionTile(
              context,
              title: 'Deneyimlerim',
              page: EditExperiencesPage(),
            ),
            _buildSectionTile(
              context,
              title: 'Eğitim Hayatım',
              page: EditEducationPage(),
            ),
            _buildSectionTile(
              context,
            ...
            _buildSectionTile(
              ...
              page: EditCertificatesPage(),
            ),
            _buildSectionTile(
              context,
              title: 'Üye Topluluklar',
              page: EditCommunitiesPage(),
            ),
            _buildSectionTile(
              context,
              title: 'Projeler ve Ödüller',
              page: EditProjectsAwardsPage(),
            ),
            _buildSectionTile(
              context,
              title: 'Medya Hesaplarım',
              page: EditSocialMediaPage(),
            ),
            _buildSectionTile(
              context,
              title: 'Yabancı Dillerim',
              page: EditLanguagesPage(),
            ),
